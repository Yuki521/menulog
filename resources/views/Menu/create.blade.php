    ...
    <form method="POST" action="{{route('menu.store')}}">
        <table>
            ...
            <tr>
                <th>メニュー名</th>
                <td class="px-2 py-2">
                    <input class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" type="text" name="title" value="{{old('title')}}">
                </td>
                @error('title')
            ...
            <tr>
                <th>タイプ</th>
                <td class="px-2 py-2"><input class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" type="text" name="type" value="{{old('type')}}"></td>
                @error('type')
                <td class="px-2 py-2">{{$message}}</td>
                @enderror
            </tr>
